...
GLFWAPI GLFWcursor* glfwCreateStandardCursor(int shape)
{
	...
	switch (shape)
	{
	case GLFW_NORMAL_CURSOR:
	case GLFW_IBEAM_CURSOR:
	case GLFW_WAIT_CURSOR:
	case GLFW_CROSS_CURSOR:
	case GLFW_UP_CURSOR:
	case GLFW_SIZENWSE_CURSOR:
	case GLFW_SIZENESW_CURSOR:
	case GLFW_SIZEWE_CURSOR:
	case GLFW_SIZENS_CURSOR:
	case GLFW_SIZEALL_CURSOR:
	case GLFW_NO_CURSOR:
