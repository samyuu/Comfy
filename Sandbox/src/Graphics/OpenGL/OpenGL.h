...
#pragma region OpenGL Constant Defines
...
#define glIsFramebuffer 						Graphics::OpenGL::Comfy_glIsFramebuffer
...
#define glIsBuffer 								Graphics::OpenGL::Comfy_glIsBuffer
...
#define glIsSampler 							Graphics::OpenGL::Comfy_glIsSampler
...
namespace Graphics
{
	...
	{
	public:
		static PFNGLTEXPARAMETERFPROC*							Comfy_glTexParameterf;
		static PFNGLTEXPARAMETERFVPROC*							Comfy_glTexParameterfv;
		static PFNGLTEXPARAMETERIPROC*							Comfy_glTexParameteri;
		static PFNGLTEXPARAMETERIVPROC*							Comfy_glTexParameteriv;
		static PFNGLTEXIMAGE1DPROC*								Comfy_glTexImage1D;
		static PFNGLTEXIMAGE2DPROC*								Comfy_glTexImage2D;
		static PFNGLDRAWBUFFERPROC*								Comfy_glDrawBuffer;
		static PFNGLCLEARPROC*									Comfy_glClear;
		static PFNGLCLEARCOLORPROC*								Comfy_glClearColor;
		static PFNGLDRAWARRAYSPROC*								Comfy_glDrawArrays;
		static PFNGLDRAWELEMENTSPROC*							Comfy_glDrawElements;
		static PFNGLGETPOINTERVPROC*							Comfy_glGetPointerv;
		static PFNGLPOLYGONOFFSETPROC*							Comfy_glPolygonOffset;
		static PFNGLCOPYTEXIMAGE1DPROC*							Comfy_glCopyTexImage1D;
		static PFNGLCOPYTEXIMAGE2DPROC*							Comfy_glCopyTexImage2D;
		static PFNGLCOPYTEXSUBIMAGE1DPROC*						Comfy_glCopyTexSubImage1D;
		static PFNGLCOPYTEXSUBIMAGE2DPROC*						Comfy_glCopyTexSubImage2D;
		static PFNGLTEXSUBIMAGE1DPROC*							Comfy_glTexSubImage1D;
		static PFNGLTEXSUBIMAGE2DPROC*							Comfy_glTexSubImage2D;
		static PFNGLBINDTEXTUREPROC*							Comfy_glBindTexture;
		static PFNGLDELETETEXTURESPROC*							Comfy_glDeleteTextures;
		static PFNGLGENTEXTURESPROC*							Comfy_glGenTextures;
		static PFNGLLINEWIDTHPROC*								Comfy_glLineWidth;
		static PFNGLPOINTSIZEPROC*								Comfy_glPointSize;
		static PFNGLPOLYGONMODEPROC*							Comfy_glPolygonMode;
		static PFNGLSCISSORPROC*								Comfy_glScissor;
		static PFNGLDISABLEPROC*								Comfy_glDisable;
		static PFNGLENABLEPROC*									Comfy_glEnable;
		static PFNGLBLENDFUNCPROC*								Comfy_glBlendFunc;
		static PFNGLSTENCILFUNCPROC*							Comfy_glStencilFunc;
		static PFNGLDEPTHFUNCPROC*								Comfy_glDepthFunc;
		static PFNGLPIXELSTOREFPROC*							Comfy_glPixelStoref;
		static PFNGLPIXELSTOREIPROC*							Comfy_glPixelStorei;
		static PFNGLREADBUFFERPROC*								Comfy_glReadBuffer;
		static PFNGLREADPIXELSPROC*								Comfy_glReadPixels;
		static PFNGLGETBOOLEANVPROC*							Comfy_glGetBooleanv;
		static PFNGLGETDOUBLEVPROC*								Comfy_glGetDoublev;
		static PFNGLGETERRORPROC*								Comfy_glGetError;
		static PFNGLGETFLOATVPROC*								Comfy_glGetFloatv;
		static PFNGLGETINTEGERVPROC*							Comfy_glGetIntegerv;
		static PFNGLGETSTRINGPROC*								Comfy_glGetString;
		static PFNGLGETTEXIMAGEPROC*							Comfy_glGetTexImage;
		static PFNGLGETTEXPARAMETERFVPROC*						Comfy_glGetTexParameterfv;
		static PFNGLGETTEXPARAMETERIVPROC*						Comfy_glGetTexParameteriv;
		static PFNGLGETTEXLEVELPARAMETERFVPROC*					Comfy_glGetTexLevelParameterfv;
		static PFNGLGETTEXLEVELPARAMETERIVPROC*					Comfy_glGetTexLevelParameteriv;
		static PFNGLISENABLEDPROC*								Comfy_glIsEnabled;
		static PFNGLDEPTHRANGEPROC*								Comfy_glDepthRange;
		static PFNGLVIEWPORTPROC*								Comfy_glViewport;
		static PFNGLVERTEXATTRIBPOINTERPROC*					Comfy_glVertexAttribPointer;
		static PFNGLGETATTRIBLOCATIONPROC*						Comfy_glGetAttribLocation;
		static PFNGLGETPROGRAMIVPROC*							Comfy_glGetProgramiv;
		static PFNGLGETPROGRAMINFOLOGPROC*						Comfy_glGetProgramInfoLog;
		static PFNGLGETSHADERIVPROC*							Comfy_glGetShaderiv;
		static PFNGLGETSHADERINFOLOGPROC*						Comfy_glGetShaderInfoLog;
		static PFNGLGETSHADERSOURCEPROC*						Comfy_glGetShaderSource;
		static PFNGLGETUNIFORMLOCATIONPROC*						Comfy_glGetUniformLocation;
		static PFNGLGETUNIFORMFVPROC*							Comfy_glGetUniformfv;
		static PFNGLGETUNIFORMIVPROC*							Comfy_glGetUniformiv;
		static PFNGLGETVERTEXATTRIBDVPROC*						Comfy_glGetVertexAttribdv;
		static PFNGLGETVERTEXATTRIBFVPROC*						Comfy_glGetVertexAttribfv;
		static PFNGLGETVERTEXATTRIBIVPROC*						Comfy_glGetVertexAttribiv;
		static PFNGLGETVERTEXATTRIBPOINTERVPROC*				Comfy_glGetVertexAttribPointerv;
		static PFNGLLINKPROGRAMPROC*							Comfy_glLinkProgram;
		static PFNGLSHADERSOURCEPROC*							Comfy_glShaderSource;
		static PFNGLUSEPROGRAMPROC*								Comfy_glUseProgram;
		static PFNGLUNIFORM1FPROC*								Comfy_glUniform1f;
		static PFNGLUNIFORM2FPROC*								Comfy_glUniform2f;
		static PFNGLUNIFORM3FPROC*								Comfy_glUniform3f;
		static PFNGLUNIFORM4FPROC*								Comfy_glUniform4f;
		static PFNGLUNIFORM1IPROC*								Comfy_glUniform1i;
		static PFNGLUNIFORM2IPROC*								Comfy_glUniform2i;
		static PFNGLUNIFORM3IPROC*								Comfy_glUniform3i;
		static PFNGLUNIFORM4IPROC*								Comfy_glUniform4i;
		static PFNGLUNIFORM1FVPROC*								Comfy_glUniform1fv;
		static PFNGLUNIFORM2FVPROC*								Comfy_glUniform2fv;
		static PFNGLUNIFORM3FVPROC*								Comfy_glUniform3fv;
		static PFNGLUNIFORM4FVPROC*								Comfy_glUniform4fv;
		static PFNGLUNIFORM1IVPROC*								Comfy_glUniform1iv;
		static PFNGLUNIFORM2IVPROC*								Comfy_glUniform2iv;
		static PFNGLUNIFORM3IVPROC*								Comfy_glUniform3iv;
		static PFNGLUNIFORM4IVPROC*								Comfy_glUniform4iv;
		static PFNGLUNIFORMMATRIX2FVPROC*						Comfy_glUniformMatrix2fv;
		static PFNGLUNIFORMMATRIX3FVPROC*						Comfy_glUniformMatrix3fv;
		static PFNGLUNIFORMMATRIX4FVPROC*						Comfy_glUniformMatrix4fv;
		static PFNGLACTIVETEXTUREPROC*							Comfy_glActiveTexture;
		static PFNGLCOMPRESSEDTEXIMAGE3DPROC*					Comfy_glCompressedTexImage3D;
		static PFNGLCOMPRESSEDTEXIMAGE2DPROC*					Comfy_glCompressedTexImage2D;
		static PFNGLCOMPRESSEDTEXIMAGE1DPROC*					Comfy_glCompressedTexImage1D;
		static PFNGLCOMPRESSEDTEXSUBIMAGE3DPROC*				Comfy_glCompressedTexSubImage3D;
		static PFNGLCOMPRESSEDTEXSUBIMAGE2DPROC*				Comfy_glCompressedTexSubImage2D;
		static PFNGLCOMPRESSEDTEXSUBIMAGE1DPROC*				Comfy_glCompressedTexSubImage1D;
		static PFNGLBLENDFUNCSEPARATEPROC*						Comfy_glBlendFuncSeparate;
		static PFNGLMULTIDRAWARRAYSPROC*						Comfy_glMultiDrawArrays;
		static PFNGLMULTIDRAWELEMENTSPROC*						Comfy_glMultiDrawElements;
		static PFNGLBINDRENDERBUFFERPROC*						Comfy_glBindRenderbuffer;
		static PFNGLDELETERENDERBUFFERSPROC*					Comfy_glDeleteRenderbuffers;
		static PFNGLGENRENDERBUFFERSPROC*						Comfy_glGenRenderbuffers;
		static PFNGLRENDERBUFFERSTORAGEPROC*					Comfy_glRenderbufferStorage;
		static PFNGLGETRENDERBUFFERPARAMETERIVPROC*				Comfy_glGetRenderbufferParameteriv;
		static PFNGLISFRAMEBUFFERPROC*							Comfy_glIsFramebuffer;
		static PFNGLBINDFRAMEBUFFERPROC*						Comfy_glBindFramebuffer;
		static PFNGLDELETEFRAMEBUFFERSPROC*						Comfy_glDeleteFramebuffers;
		static PFNGLGENFRAMEBUFFERSPROC*						Comfy_glGenFramebuffers;
		static PFNGLCHECKFRAMEBUFFERSTATUSPROC*					Comfy_glCheckFramebufferStatus;
		static PFNGLFRAMEBUFFERTEXTURE1DPROC*					Comfy_glFramebufferTexture1D;
		static PFNGLFRAMEBUFFERTEXTURE2DPROC*					Comfy_glFramebufferTexture2D;
		static PFNGLFRAMEBUFFERTEXTURE3DPROC*					Comfy_glFramebufferTexture3D;
		static PFNGLFRAMEBUFFERRENDERBUFFERPROC*				Comfy_glFramebufferRenderbuffer;
		static PFNGLGETFRAMEBUFFERATTACHMENTPARAMETERIVPROC*	Comfy_glGetFramebufferAttachmentParameteriv;
		static PFNGLGENERATEMIPMAPPROC*							Comfy_glGenerateMipmap;
		static PFNGLBLENDEQUATIONSEPARATEPROC*					Comfy_glBlendEquationSeparate;
		static PFNGLATTACHSHADERPROC*							Comfy_glAttachShader;
		static PFNGLCOMPILESHADERPROC*							Comfy_glCompileShader;
		static PFNGLCREATEPROGRAMPROC*							Comfy_glCreateProgram;
		static PFNGLCREATESHADERPROC*							Comfy_glCreateShader;
		static PFNGLDELETEPROGRAMPROC*							Comfy_glDeleteProgram;
		static PFNGLDELETESHADERPROC*							Comfy_glDeleteShader;
		static PFNGLDETACHSHADERPROC*							Comfy_glDetachShader;
		static PFNGLDISABLEVERTEXATTRIBARRAYPROC*				Comfy_glDisableVertexAttribArray;
		static PFNGLENABLEVERTEXATTRIBARRAYPROC*				Comfy_glEnableVertexAttribArray;
		static PFNGLGETACTIVEATTRIBPROC*						Comfy_glGetActiveAttrib;
		static PFNGLBLENDCOLORPROC*								Comfy_glBlendColor;
		static PFNGLBLENDEQUATIONPROC*							Comfy_glBlendEquation;
		static PFNGLBINDBUFFERPROC*								Comfy_glBindBuffer;
		static PFNGLDELETEBUFFERSPROC*							Comfy_glDeleteBuffers;
		static PFNGLGENBUFFERSPROC*								Comfy_glGenBuffers;
		static PFNGLISBUFFERPROC*								Comfy_glIsBuffer;
		static PFNGLBUFFERDATAPROC*								Comfy_glBufferData;
		static PFNGLBUFFERSUBDATAPROC*							Comfy_glBufferSubData;
		static PFNGLGETBUFFERSUBDATAPROC*						Comfy_glGetBufferSubData;
		static PFNGLMAPBUFFERPROC*								Comfy_glMapBuffer;
		static PFNGLUNMAPBUFFERPROC*							Comfy_glUnmapBuffer;
		static PFNGLBINDVERTEXARRAYPROC*						Comfy_glBindVertexArray;
		static PFNGLDELETEVERTEXARRAYSPROC*						Comfy_glDeleteVertexArrays;
		static PFNGLGENVERTEXARRAYSPROC*						Comfy_glGenVertexArrays;
		static PFNGLGETBUFFERPARAMETERIVPROC*					Comfy_glGetBufferParameteriv;
		static PFNGLGETBUFFERPOINTERVPROC*						Comfy_glGetBufferPointerv;
		static PFNGLGENSAMPLERSPROC*							Comfy_glGenSamplers;
		static PFNGLDELETESAMPLERSPROC*							Comfy_glDeleteSamplers;
		static PFNGLISSAMPLERPROC*								Comfy_glIsSampler;
		static PFNGLBINDSAMPLERPROC*							Comfy_glBindSampler;
		static PFNGLSAMPLERPARAMETERIPROC*						Comfy_glSamplerParameteri;
		static PFNGLSAMPLERPARAMETERIVPROC*						Comfy_glSamplerParameteriv;
		static PFNGLSAMPLERPARAMETERFPROC*						Comfy_glSamplerParameterf;
		static PFNGLSAMPLERPARAMETERFVPROC*						Comfy_glSamplerParameterfv;
		static PFNGLSAMPLERPARAMETERIIVPROC*					Comfy_glSamplerParameterIiv;
		static PFNGLSAMPLERPARAMETERIUIVPROC*					Comfy_glSamplerParameterIuiv;
		static PFNGLGETSAMPLERPARAMETERIVPROC*					Comfy_glGetSamplerParameteriv;
		static PFNGLGETSAMPLERPARAMETERIIVPROC*					Comfy_glGetSamplerParameterIiv;
		static PFNGLGETSAMPLERPARAMETERFVPROC*					Comfy_glGetSamplerParameterfv;
		static PFNGLGETSAMPLERPARAMETERIUIVPROC*				Comfy_glGetSamplerParameterIuiv;
	};
}
