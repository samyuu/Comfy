...
namespace Graphics
{
	...
	DECLARE_BYTECODE_GETTER(PPGauss_VS);
	DECLARE_BYTECODE_GETTER(PPGauss_PS);
	DECLARE_BYTECODE_GETTER(ReduceTex_VS);
	...
	DECLARE_BYTECODE_GETTER(SSSFilter_VS);
...
#include SHADER_BYTECODE_FILE(PPGauss_VS.h)
#include SHADER_BYTECODE_FILE(PPGauss_PS.h)
#include SHADER_BYTECODE_FILE(ReduceTex_VS.h)
...
#include SHADER_BYTECODE_FILE(SSSFilter_VS.h)
...
namespace Graphics
{
	...
	DEFINE_BYTECODE_GETTER(PPGauss_VS);
	DEFINE_BYTECODE_GETTER(PPGauss_PS);
	DEFINE_BYTECODE_GETTER(ReduceTex_VS);
	...
	DEFINE_BYTECODE_GETTER(SSSFilter_VS);
