...
#if COMFY_DEBUG
#define SHADER_BYTECODE_FILE(filename) STRINGIFY(Intermediate/DXBC-Debug/##filename)
#elif COMFY_RELEASE
#define SHADER_BYTECODE_FILE(filename) STRINGIFY(Intermediate/DXBC-Release/##filename)
#else
