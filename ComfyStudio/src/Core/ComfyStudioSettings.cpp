	...
	void ComfyStudioUserSettings::RestoreDefault()
	{
		*this = {};
...

		{
			...
			Input.App_ToggleFullscreen = MultiBinding(Binding(KeyCode_F11, KeyModifiers_None, ModifierBehavior_Strict));
			Input.App_Dialog_YesOrOk = MultiBinding(Binding(KeyCode_Enter, KeyModifiers_None, ModifierBehavior_Strict));
			Input.App_Dialog_No = MultiBinding(Binding(KeyCode_Backspace, KeyModifiers_None, ModifierBehavior_Strict));
			Input.App_Dialog_Cancel = MultiBinding(Binding(KeyCode_Escape, KeyModifiers_None, ModifierBehavior_Strict));
			Input.App_Dialog_SelectNextTab = MultiBinding(Binding(KeyCode_Tab, KeyModifiers_Ctrl, ModifierBehavior_Strict));
			Input.App_Dialog_SelectPreviousTab = MultiBinding(Binding(KeyCode_Tab, KeyModifiers_CtrlShift, ModifierBehavior_Strict));

			Input.ChartEditor_ChartNew = MultiBinding(Binding(KeyCode_N, KeyModifiers_Ctrl, ModifierBehavior_Strict));
			Input.ChartEditor_ChartOpen = MultiBinding(Binding(KeyCode_O, KeyModifiers_Ctrl, ModifierBehavior_Strict));
			Input.ChartEditor_ChartSave = MultiBinding(Binding(KeyCode_S, KeyModifiers_Ctrl, ModifierBehavior_Strict));
			Input.ChartEditor_ChartSaveAs = MultiBinding(Binding(KeyCode_S, KeyModifiers_CtrlShift, ModifierBehavior_Strict));
			Input.ChartEditor_ChartOpenDirectory = {};
			Input.ChartEditor_Undo = MultiBinding(Binding(KeyCode_Z, KeyModifiers_Ctrl, ModifierBehavior_Strict));
			Input.ChartEditor_Redo = MultiBinding(Binding(KeyCode_Y, KeyModifiers_Ctrl, ModifierBehavior_Strict));
			Input.ChartEditor_OpenSettings = MultiBinding(Binding(KeyCode_OEMComma, KeyModifiers_Ctrl, ModifierBehavior_Strict));
			Input.ChartEditor_StartPlaytestFromStart = MultiBinding(Binding(KeyCode_F5, KeyModifiers_None, ModifierBehavior_Strict));
			Input.ChartEditor_StartPlaytestFromCursor = MultiBinding(Binding(KeyCode_F6, KeyModifiers_None, ModifierBehavior_Strict));

			Input.Timeline_CenterCursor = MultiBinding(Binding(KeyCode_Escape, KeyModifiers_None, ModifierBehavior_Strict));
			Input.Timeline_TogglePlayback = MultiBinding(Binding(KeyCode_Space, KeyModifiers_None, ModifierBehavior_Relaxed));
			Input.Timeline_StopPlayback = MultiBinding(Binding(KeyCode_Escape, KeyModifiers_None, ModifierBehavior_Strict));

			Input.TargetTimeline_Cut = MultiBinding(Binding(KeyCode_X, KeyModifiers_Ctrl, ModifierBehavior_Strict));
			Input.TargetTimeline_Copy = MultiBinding(Binding(KeyCode_C, KeyModifiers_Ctrl, ModifierBehavior_Strict));
			...
			Input.TargetTimeline_IncreaseGridPrecision = MultiBinding(Binding(KeyCode_Up, KeyModifiers_None, ModifierBehavior_Relaxed));
			Input.TargetTimeline_DecreaseGridPrecision = MultiBinding(Binding(KeyCode_Down, KeyModifiers_None, ModifierBehavior_Relaxed));
			...
			Input.TargetTimeline_DecreasePlaybackSpeed = MultiBinding(Binding(KeyCode_OEMComma, KeyModifiers_None, ModifierBehavior_Strict));
			Input.TargetTimeline_ToggleMetronome = MultiBinding(Binding(KeyCode_M, KeyModifiers_None, ModifierBehavior_Strict));
			Input.TargetTimeline_ToggleTargetHolds = MultiBinding(Binding(KeyCode_F, KeyModifiers_None, ModifierBehavior_Relaxed));
			Input.TargetTimeline_PlaceTriangle = MultiBinding(Binding(KeyCode_W, KeyModifiers_None, ModifierBehavior_Relaxed), Binding(KeyCode_I, KeyModifiers_None, ModifierBehavior_Relaxed));
			Input.TargetTimeline_PlaceSquare = MultiBinding(Binding(KeyCode_A, KeyModifiers_None, ModifierBehavior_Relaxed), Binding(KeyCode_J, KeyModifiers_None, ModifierBehavior_Relaxed));
			Input.TargetTimeline_PlaceCross = MultiBinding(Binding(KeyCode_S, KeyModifiers_None, ModifierBehavior_Relaxed), Binding(KeyCode_K, KeyModifiers_None, ModifierBehavior_Relaxed));
			Input.TargetTimeline_PlaceCircle = MultiBinding(Binding(KeyCode_D, KeyModifiers_None, ModifierBehavior_Relaxed), Binding(KeyCode_L, KeyModifiers_None, ModifierBehavior_Relaxed));
			Input.TargetTimeline_PlaceSlideL = MultiBinding(Binding(KeyCode_Q, KeyModifiers_None, ModifierBehavior_Relaxed), Binding(KeyCode_U, KeyModifiers_None, ModifierBehavior_Relaxed));
			Input.TargetTimeline_PlaceSlideR = MultiBinding(Binding(KeyCode_E, KeyModifiers_None, ModifierBehavior_Relaxed), Binding(KeyCode_O, KeyModifiers_None, ModifierBehavior_Relaxed));

			Input.TargetPreview_JumpToPreviousTarget = MultiBinding(Binding(KeyCode_Q, KeyModifiers_None, ModifierBehavior_Relaxed));
			Input.TargetPreview_JumpToNextTarget = MultiBinding(Binding(KeyCode_E, KeyModifiers_None, ModifierBehavior_Relaxed));
			Input.TargetPreview_TogglePlayback = Input.Timeline_TogglePlayback;
			Input.TargetPreview_SelectPositionTool = MultiBinding(Binding(KeyCode_1, KeyModifiers_None, ModifierBehavior_Strict));
			Input.TargetPreview_SelectPathTool = MultiBinding(Binding(KeyCode_2, KeyModifiers_None, ModifierBehavior_Strict));
			Input.TargetPreview_PositionTool_MoveUp = MultiBinding(Binding(KeyCode_W, KeyModifiers_None, ModifierBehavior_Relaxed), Binding(KeyCode_Up, KeyModifiers_None, ModifierBehavior_Relaxed));
			Input.TargetPreview_PositionTool_MoveLeft = MultiBinding(Binding(KeyCode_A, KeyModifiers_None, ModifierBehavior_Relaxed), Binding(KeyCode_Left, KeyModifiers_None, ModifierBehavior_Relaxed));
			Input.TargetPreview_PositionTool_MoveDown = MultiBinding(Binding(KeyCode_S, KeyModifiers_None, ModifierBehavior_Relaxed), Binding(KeyCode_Down, KeyModifiers_None, ModifierBehavior_Relaxed));
			Input.TargetPreview_PositionTool_MoveRight = MultiBinding(Binding(KeyCode_D, KeyModifiers_None, ModifierBehavior_Relaxed), Binding(KeyCode_Right, KeyModifiers_None, ModifierBehavior_Relaxed));
			Input.TargetPreview_PositionTool_FlipHorizontal = MultiBinding(Binding(KeyCode_H, KeyModifiers_None, ModifierBehavior_Strict));
			Input.TargetPreview_PositionTool_FlipHorizontalLocal = MultiBinding(Binding(KeyCode_H, KeyModifiers_Alt, ModifierBehavior_Strict));
			Input.TargetPreview_PositionTool_FlipVertical = MultiBinding(Binding(KeyCode_J, KeyModifiers_None, ModifierBehavior_Strict));
			Input.TargetPreview_PositionTool_FlipVerticalLocal = MultiBinding(Binding(KeyCode_J, KeyModifiers_Alt, ModifierBehavior_Strict));
			Input.TargetPreview_PositionTool_PositionInRow = MultiBinding(Binding(KeyCode_U, KeyModifiers_None, ModifierBehavior_Strict));
			Input.TargetPreview_PositionTool_PositionInRowBack = MultiBinding(Binding(KeyCode_U, KeyModifiers_Alt, ModifierBehavior_Strict));
			Input.TargetPreview_PositionTool_InterpolateLinear = MultiBinding(Binding(KeyCode_I, KeyModifiers_None, ModifierBehavior_Strict));
			Input.TargetPreview_PositionTool_InterpolateCircular = MultiBinding(Binding(KeyCode_O, KeyModifiers_None, ModifierBehavior_Strict));
			Input.TargetPreview_PositionTool_InterpolateCircularFlip = MultiBinding(Binding(KeyCode_O, KeyModifiers_Alt, ModifierBehavior_Strict));
			Input.TargetPreview_PositionTool_StackPositions = MultiBinding(Binding(KeyCode_P, KeyModifiers_None, ModifierBehavior_Strict));
			Input.TargetPreview_PathTool_InvertFrequencies = MultiBinding(Binding(KeyCode_R, KeyModifiers_None, ModifierBehavior_Relaxed));
			Input.TargetPreview_PathTool_InterpolateAnglesClockwise = MultiBinding(Binding(KeyCode_U, KeyModifiers_None, ModifierBehavior_Strict));
			Input.TargetPreview_PathTool_InterpolateAnglesCounterclockwise = MultiBinding(Binding(KeyCode_I, KeyModifiers_None, ModifierBehavior_Strict));
			Input.TargetPreview_PathTool_InterpolateDistances = MultiBinding(Binding(KeyCode_O, KeyModifiers_None, ModifierBehavior_Strict));
			Input.TargetPreview_PathTool_ApplyAngleIncrementsPositive = MultiBinding(Binding(KeyCode_F, KeyModifiers_None, ModifierBehavior_Relaxed));
			Input.TargetPreview_PathTool_ApplyAngleIncrementsPositiveBack = MultiBinding(Binding(KeyCode_F, KeyModifiers_Alt, ModifierBehavior_Relaxed));
			Input.TargetPreview_PathTool_ApplyAngleIncrementsNegative = MultiBinding(Binding(KeyCode_V, KeyModifiers_None, ModifierBehavior_Relaxed));
			Input.TargetPreview_PathTool_ApplyAngleIncrementsNegativeBack = MultiBinding(Binding(KeyCode_V, KeyModifiers_Alt, ModifierBehavior_Relaxed));

			Input.BPMCalculator_Tap = MultiBinding(Binding(KeyCode_Space, KeyModifiers_None, ModifierBehavior_Strict));
			Input.BPMCalculator_Reset = MultiBinding(Binding(KeyCode_Escape, KeyModifiers_None, ModifierBehavior_Strict));

			Input.Playtest_ReturnToEditorCurrent = MultiBinding(Binding(KeyCode_Escape, KeyModifiers_None, ModifierBehavior_Strict));
			Input.Playtest_ReturnToEditorPrePlaytest = MultiBinding(Binding(KeyCode_Escape, KeyModifiers_Shift, ModifierBehavior_Strict));
			Input.Playtest_ToggleAutoplay = MultiBinding(Binding(KeyCode_F1, KeyModifiers_None, ModifierBehavior_Strict));
			Input.Playtest_TogglePause = MultiBinding(Binding(KeyCode_Space, KeyModifiers_None, ModifierBehavior_Strict), Binding(Button::Start));
