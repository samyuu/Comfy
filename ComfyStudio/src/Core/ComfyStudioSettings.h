...
namespace Comfy::Studio
{
	...
	{
		static constexpr SemanticVersion CurrentVersion = { 1, 5, 1 };
	...
	{
		static constexpr SemanticVersion CurrentVersion = { 1, 42, 1 };
		...
		struct
		{
			...
			struct
			{
				...
				bool ShareSongTitleAndArtist;
				bool ShareEditorOrPlaytestState;
		...
		struct
		{
			...
			bool MouseWheelZoomAroundTimelineCursorDuringPlayback;
