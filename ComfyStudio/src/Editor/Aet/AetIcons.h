...
#define ICON_AETSURFACES	ICON_FA_IMAGES
#define ICON_AETSURFACE		ICON_FA_IMAGE
#define ICON_AETPLACEHOLDER	ICON_FA_EXPAND
#define ICON_AETLAYERNOP	ICON_FA_QUESTION_CIRCLE
#define ICON_AETLAYERPIC	ICON_FA_CUBE
#define ICON_AETLAYERAIF	ICON_FA_MUSIC
#define ICON_AETLAYEREFF	ICON_FA_CUBES
#define ICON_ANIMATIONDATA	ICON_FA_INFO_CIRCLE
#define ICON_MARKERS		ICON_FA_MAP_MARKER_ALT
#define ICON_PARENT			ICON_AETLAYERPIC
